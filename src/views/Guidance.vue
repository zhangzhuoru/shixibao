<template>
    <div class="week">
        <h1 style="margin: 10px 0;">查看实习项目的实习情况</h1>
          <div class="approve">
            <div class="hearder">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 100%" ref="checkTable" :row-key="handleReserve"
              ...
              <el-table-column label="巡访日期" align="center" prop="date">
              </el-table-column>
              <el-table-column label="巡访企业" align="center" prop="address">
              </el-table-column>
              <el-table-column label="巡访形式" align="center" prop="major">
              </el-table-column>
              <el-table-column label="巡访学生" align="center" prop="name">
              </el-table-column>
              <el-table-column label="巡访总结" align="center" prop="department">
              </el-table-column>
