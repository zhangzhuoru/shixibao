<template>
    <div class="notice">
      <el-tabs @tab-click="changeSys" v-model="activeName" tab-position="top" style="height: 200px;" >
        <el-tab-pane label="未签到" name='1'>
          <div class="approve" v-if='activeName==1'>
            <div class="hearder">
              <div style="margin-top: 6px;">
                <el-button type="success" size="mini" round icon="el-icon-check">批量提醒</el-button>
              </div>
              <div>
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 100%" ref="checkTable" :row-key="handleReserve"
              ...
              <el-table-column label="时间" align="center" prop="date" width="100">
              </el-table-column>
              <el-table-column label="姓名" align="center" prop="name">
              </el-table-column>
              <el-table-column label="学号" align="center" prop="id">
              </el-table-column>
              <el-table-column label="签约单位" :show-overflow-tooltip="true" width="100" align="center" header-align="center" prop="address">
              </el-table-column>
              <el-table-column label="签到时间" align="center" prop="date">
              </el-table-column>
              <el-table-column label="签到地点" width="100">
            ...
                  </template>
              ...
              <el-table-column width="260" align="center" label="操作">
                <template slot-scope="scope" class="between">
                  <el-button type="primary" size="mini">提醒签到</el-button>
                </template>
              </el-table-column>
            </el-table>
        ...
        <el-tab-pane label="已签到" name='2'>
          <div class="approve" v-if='activeName==2'>
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" style="width: 100%">
              ...
              <el-table-column label="签约单位" :show-overflow-tooltip="true" width="100" align="center" prop="address">
              </el-table-column>
